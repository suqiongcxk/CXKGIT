...
//#define    MY_ID_diantiao   MASTER_ID
...
extern volatile uint16_t  current_Send_frame_type ;
//用来管理每次485的接收类型
extern volatile uint16_t  current_Receive_frame_type ;
extern volatile uint16_t  Receive_frame_4ID[4]  ;
extern volatile uint16_t  Receive_frame_2ID[4] ;
...
#define      Distance_Frame                     0x27     //位移帧
#define      DISTANCE_OK_Frame                  0x28     //位移完成帧
#define      DISTANCE_Uncomplete_Frame          0x39    //位移错误帧
